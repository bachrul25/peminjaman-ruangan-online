...
const About = () => {
    return (
        <section
        className="relative bg-cover bg-center bg-no-repeat text-white py-36"
        style={{ backgroundImage: `url(${bgAbout})` }}
        >
        <div className="w-auto px-[160px]">
            <h2 className="text-5xl hind-madurai-bold mb-14">ABOUT ROOMPI</h2>

            <div className="border-t border-white w-full pt-12"></div>
                {/* Grid 2 kolom: Deskripsi dan Gambar */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-36 items-start">
                {/* Deskripsi */}
                <div>
                    <p className="text-xl hind-madurai-regular">
