...
const Newsletter = () => {
    return (
        <section className="bg-white py-28 px-[160px]">
        <div className="max-w-7xl mx-auto rounded-3xl overflow-hidden flex flex-col md:flex-row shadow-lg">
            ...
            {/* Konten Kanan */}
            <div className="bg-secondary md:w-2/3 flex flex-col justify-center items-center p-8">
            <h2 className="text-4xl hind-madurai-bold text-center text-black leading-snug">
            ...
            <form className="mt-6 w-full max-w-md flex">
                ...
                <button
                type="submit"
                className="ml-4 px-6 py-3 bg-primary text-white hind-madurai-bold rounded-full text-base transition"
                >
                Subscribe
                </button>
            </form>
